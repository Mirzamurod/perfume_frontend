...
import TableHeader from '@/view/purchased-products/TableHeader'
import Table from '@/components/Table'
import { TSortModel } from '@/types/table'
import { useAppSelector } from '@/store'
import columns from '@/view/purchased-products/columns'
import { getPurchasedProducts } from '@/store/purchased_product'
